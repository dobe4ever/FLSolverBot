...
function evalHand(hand) {
  ...
  *Time:* ${solveTime}s`;
  ...
  function solver(parsedCards) {
    console.log('🔍 [FL-SOLVER] Starting solver with', parsedCards.length, 'cards');
    ...
    console.log('⏱️  [FL-SOLVER] Step 1: Generating all 5-card combinations...');
    ...
    console.log('✅ [FL-SOLVER] Step 1 complete:', fiveCardHands.length, 'five-card hands generated in', (Date.now() - step1Start), 'ms');
    
    console.log('⏱️  [FL-SOLVER] Step 2: Sorting five-card hands by ROYALTY first...');
    ...
    console.log('✅ [FL-SOLVER] Step 2 complete: Sorted in', (Date.now() - step2Start), 'ms');
    ...
    console.log('⏱️  [FL-SOLVER] Step 3: Main search loop with Dynamic Pruning...');
    ...
    console.log(`✅ [FL-SOLVER] Step 3 complete in ${(Date.now() - step3Start)} ms.`);
    console.log(`   [FL-SOLVER] Stats: Pairs checked: ${pairCount} | Pairs pruned: ${prunedCount} | Cache hits: ${cacheHits} | Cache size: ${frontHandCache.size}`);
  
    if (!bestOverallArrangement) {
      throw new Error("Solver returned no valid arrangement");
    }
    
    console.log('⏱️  [FL-SOLVER] Step 4: Final selection...');
    ...
    console.log('✅ [FL-SOLVER] Step 4 complete in', (Date.now() - step4Start), 'ms');
    
    const solveTime = ((Date.now() - solverStartTime) / 1000).toFixed(3);
    console.log('🎉 [FL-SOLVER] TOTAL SOLVER TIME:', solveTime * 1000, 'ms');
